...
namespace MarCmd
{
	...
	#define DbgWndName_DisasmViewControlSplit "Disassembly View Control Split"
	#define DbgWndName_DisasmViewControlInsPtr "Disassembly View Control Instruction Pointer"
	#define DbgWndName_DisasmViewControlBreakpoints "Disassembly View Control Breakpoints"
